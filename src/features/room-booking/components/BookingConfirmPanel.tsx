...
import { SelectedStudentsSummary } from './booking-confirm-panel/SelectedStudentsSummary';
import { StudentPickerModal } from './booking-confirm-panel/StudentPickerModal';
import type { BookingStudent, ManualStudentDraft, SelectedGroupBucket } from './booking-confirm-panel/types';
import { buildStudentsForGroup, getInitials } from './booking-confirm-panel/utils';
...
export const BookingConfirmPanel: React.FC<BookingConfirmPanelProps> = ({
  ...
  const handleAddExistingGroup = (group: StudentGroup) => {
