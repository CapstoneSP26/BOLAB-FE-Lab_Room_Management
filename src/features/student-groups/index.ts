// Feature exports
export * from './types';
export * from './hooks/useStudentGroups';
export * from './api/studentGroupsApi';
...
export { default as GroupsStudentsSidebar } from './components/GroupsStudentsSidebar';
export { default as CreateGroupModal } from './components/CreateGroupModal';
export { default as UpdateGroupModal } from './components/UpdateGroupModal';
