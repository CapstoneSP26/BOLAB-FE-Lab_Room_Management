import type { StudentGroupInBooking } from '../types/group.type';
import type { BookingStudent } from '../types/group.type';


const FIRST_NAMES = ['An', 'Bao', 'Chi', 'Duc', 'Giang', 'Huy', 'Khanh', 'Linh', 'Minh', 'Phuong'];
const LAST_NAMES = ['Nguyen', 'Tran', 'Le', 'Pham', 'Hoang', 'Vo', 'Dang', 'Do'];

export const buildStudentsForGroup = (group: StudentGroupInBooking): BookingStudent[] => {
