...
import BookingRequestModal from "../features/lab-management/booking-requests/components/BookingRequestModal";
...
export function useLabManagerBookingModal() {
  // nếu role có thể đổi khi app đang chạy, dùng useMemo để đọc lại mỗi render
